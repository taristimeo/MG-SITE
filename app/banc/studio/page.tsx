...
import { StudioOpening } from "@/components/bench/StudioOpening";
...
export default function StudioPage() {
  return (
    <>
      {/* Le portrait, plein cadre : la page s'ouvre comme un plan, pas comme
          un titre posé sur du vide. Le fond bascule en salle de projection —
          le header et la barre d'état du navigateur suivent. */}
      <StudioOpening />
      ...
      {/* Clients */}
      <div data-chapter="Les clients" data-chapter-index="03">
        <Clients />
      </div>
      ...
      {/* ── Notre méthode ─────────────────────────────────────────────── */}
      <section
        data-chapter="La méthode"
        data-chapter-index="04"
        className="mx-auto mt-20 max-w-[1100px] px-5 pb-4 sm:mt-40 sm:px-8 lg:px-10"
      >
        {/* En-tête de section */}
